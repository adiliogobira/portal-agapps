...
class Web extends Controller
{
    ...
    public function plan(): void
    {
        ...
        echo $this->view->render("plan", [
            "head" => $head,
            "plans" => (new AppPlan())->find()->fetch(true),
        ]);
    }
    ...
    public function confirm(): void
    {
        ...
        echo $this->view->render("optin", [
            ...
            "data" => (object)[
                ...
                "desc" => "Enviamos um link de confirmação para seu e-mail. Acesse e siga as instruções para concluir seu cadastro e comece a controlar com o AG Apps",
