...
<header class="main_header gradient gradient-green">
  <div class="container">
    <div class="main_header_logo">
      <h1><a class="icon-coffee transition" title="Home" href="<?= url(); ?>">AG<b>Apps</b></a></h1>
    </div>
  ...
  <div class="container content">
    <section class="main_footer_content">
      <article class="main_footer_content_item">
        <h2>Sobre:</h2>
        <p>O Ag Apps é um gerenciador de contas simples, poderoso e gratuito. O prazer de tomar um café e
      ...
      <article class="main_footer_content_item">
        <h2>Contato:</h2>
        <p class="icon-phone"><b>Telefone:</b><br> <a href="wa.me/5533991437706">(33) 9.9143-7706</a></p>
        <p class="icon-envelope"><b>Email:</b><br> contato@agapps.com.br</p>
        <p class="icon-map-marker"><b>Endereço:</b><br> <?=CONF_SITE_ADDR_STREET?>, <?=CONF_SITE_ADDR_NUMBER?> <?=CONF_SITE_ADDR_COMPLEMENT?>, <?=CONF_SITE_ADDR_CITY?>/MG/Brasil</p>
      </article>

      <article class="main_footer_content_item social">
        <h2>Social:</h2>
        <a target="_blank" class="icon-facebook"
           href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="CafeControl no Facebook">/AgAppsSystem</a>
        <a target="_blank" class="icon-instagram"
           href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="CafeControl no Instagram">@adiliogobira</a>
...
<?= $v->section("scripts"); ?>
  ...
  <script>
   setTimeout(() =>{
      ...
      var links = document.querySelectorAll('div[style]');
