...
<div class="app">
  <header class="app_header">
    <h1><a class="icon-coffee transition" href="<?= url("/app"); ?>" title="<?=CONF_SITE_NAME?>"><?=CONF_SITE_NAME?></a></h1>
    <ul class="app_header_widget">
      <li
        class="radius icon-filter wallet"> <?= (session()->has("walletfilter") ? (new \Source\Models\CafeApp\AppWallet())->findById(session()->walletfilter)->wallet : "Saldo Geral"); ?>
        <ul>
