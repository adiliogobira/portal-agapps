  ...
  <article class="app_signature app_signature_me radius">
    <?php if ($subscription->status == "past_due"): ?>
      <div class="message warning icon-warning">
        ...
        <p style="margin-top: 20px">Cadastre um novo cartão de crédito <span data-go=".payment" class="message_btn">CLICANDO AQUI</span>
        </p>
      </div>
    <?php endif; ?>
    ...
    <ul class="app_signature_detail radius">
      ...
      <li><span>Cartão:</span>
        <span
          style="text-transform: uppercase"><?= $subscription->creditCard()->brand; ?> Final <?= $subscription->creditCard()->last_digits; ?></span>
      </li>
