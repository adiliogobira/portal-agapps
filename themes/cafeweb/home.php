<?php $v->layout("_theme"); ?>
  ...
  <article class="home_featured">
    ...
    <div class="home_featured_app">
      <img src="<?= theme("/assets/images/home-app.jpg"); ?>" alt="AG Apps" title="AG Apps"/>
    </div>
  </article>
  ...
  <div class="home_features">
    <section class="container content">
      <header class="home_features_header">
        <h2>O que você pode fazer com o AG Apps?</h2>
  ...
  <article class="home_optin">
    <div class="home_optin_content container content">
      <header class="home_optin_content_flex">
        <h2>Cadastre-se no AG Apps e comece a controlar suas contas hoje mesmo</h2>
        <p>Receber e pagar é uma tarefa comum do dia a dia, o AG Apps é um gerenciador de contas simples,
          fácil
