    ...
    <section class="main_footer_content">
      ...
      <article class="main_footer_content_item social">
        ...
        <a target="_blank" class="icon-facebook"
           href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="AG Apps no Facebook">/AgAppsSystem</a>
        <a target="_blank" class="icon-instagram"
           href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="AG Apps no Instagram">@adiliogobira</a>
