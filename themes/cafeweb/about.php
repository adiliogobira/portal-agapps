  ...
  <section class="about_page">
    <div class="about_page_content content">
      <header class="about_header">
        ...
        <p>Com o AG Apps você controla suas contas a pagar e receber e conta com automações e relatórios
      ...
      <div class="about_page_steps">
        ...
        <article class="radius">
          <header>
            ...
            <p>As automações do AG Apps se encarregam de gerar todos os dados necessários para você
              obter
    ...
    <aside class="about_page_cta">
      <div class="about_page_cta_content container content">
        <h2>Ainda não está usando o AG Apps?</h2>
  ...
  <section class="faq">
    <div class="faq_content content container">
      <header class="faq_header">
        ...
        <p>Confira as principais dúvidas e repostas sobre o AG Apps.</p>
      </header>
      <div class="faq_asks">
