...
/**
 * serviço para empresas se cadastrarem
 */

$route->get("/empresas","App:companies");
$route->get("/empresas/nova","");
$route->get("/empresa/{name}","");
$route->get("/empresa/{name}/editar","");

$route->post("/empresas/nova/cadastrar","");
$route->post("/empresa/{name}/update","");
...
//pages
$route->get("/page/home", "Pages:home");
$route->get("/page/home/{page}", "Pages:home");

$route->get("/page/nova", "Pages:nova");


$route->get("/page/channel/{channel_id}", "Pages:channel");
$route->post("/page/channel/{channel_id}", "Pages:channel");
$route->get("/page/question/{channel_id}", "Pages:question");
$route->post("/page/question/{channel_id}", "Pages:question");
$route->get("/page/question/{channel_id}/{question_id}", "Pages:question");
$route->post("/page/question/{channel_id}/{question_id}", "Pages:question");
